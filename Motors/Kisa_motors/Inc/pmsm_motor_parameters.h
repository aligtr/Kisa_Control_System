...
#define LS                     0.000577 /* Stator inductance, H
...
#define NOMINAL_CURRENT         4356
#define MOTOR_MAX_SPEED_RPM     300 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  21.6 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -4356 /*!< Demagnetization current */
