...
#define MAX_APPLICATION_SPEED_RPM       300 /*!< rpm, mechanical */
#define MIN_APPLICATION_SPEED_RPM       0 /*!< rpm, mechanical,  
                                                           absolute value */
#define MEAS_ERRORS_BEFORE_FAULTS       9 /*!< Number of speed  
                                                             measurement errors before 
                                                             main sensor goes in fault */
/****** Hall sensors ************/ 
#define HALL_MEAS_ERRORS_BEFORE_FAULTS  9 /*!< Number of failed   
...
#define PID_TORQUE_KD_DEFAULT         1000
#define PID_FLUX_KP_DEFAULT           1500
#define PID_FLUX_KI_DEFAULT           200
#define PID_FLUX_KD_DEFAULT           1000
...
#define PID_SPEED_KD_DEFAULT          1000/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
