...
// int16_t servoPulseCountRef[4];
// int16_t servoPulseCount[4];
// int16_t servoDir[4];

// void TIM8_BRK_TIM12_IRQHandler(void)
// {
// 	if (TIM12->SR & TIM_SR_CC1IF) {
// 		servoPulseCount[0]+=servoDir[0];
// 		if(servoPulseCount[0]<servoPulseCountRef[0])
// 		{
// 			servoDir[0]=-1;
// 		}
// 		else if(servoPulseCount[0]>servoPulseCountRef[0])
// 		{
// 			servoDir[0]=1;	
// 		}
// 		else
